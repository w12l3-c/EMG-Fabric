...
There are different datasets and different preprocessing method applied
For our own data:
...
- Using LightBGM to fit and train on the data of both datasets
...
- Using K-Means and Weighted K-Means
  - It is bad with an Accuracy of 65% on Rock Paper Scissors and training time is doubling from DNN
...
---
Future ideas:
- Real-time reflection of EMG signal on a physical device
- Try different datasets and algorithms
